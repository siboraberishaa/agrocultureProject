            ...
            <View style={styles.rowContainer}>
              <View style={styles.content}>
                ...
                <View style={styles.temperatureContainer}>
                  <Text style={styles.temperature}>Nem</Text>
              ...
              <View style={styles.content}>
                ...
                <View style={styles.temperatureContainer}>
                  <Text style={styles.temperature}>Rüzgar Hızı</Text>
                  <Text style={styles.temperature2}>1 Seviye</Text>
                </View>
              </View>
            </View>
          </LinearGradient>
